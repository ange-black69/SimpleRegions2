...
public class Explosion
{
    ...
    {
		if(dries007.SimpleRegions.regions.VanillaInterface.hasTag(worldObj, MathHelper.floor_double(this.explosionX), MathHelper.floor_double(this.explosionY), MathHelper.floor_double(this.explosionZ), "noexplosions")) {return;}
    ...
    public void doExplosionB(boolean par1)
    {
        ...
        if (this.field_82755_b)
        {
            ...
            while (var2.hasNext())
            {
                ...
                if (var7 > 0)
                {
					if (!(dries007.SimpleRegions.SimpleRegions.secureTNT && dries007.SimpleRegions.regions.VanillaInterface.hasTag(worldObj, var4, var5, var6, "noexplosions")))
                    {
