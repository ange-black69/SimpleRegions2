...
public class NetServerHandler extends NetHandler
{
    ...
    public void handlePlace(Packet15Place par1Packet15Place)
    {
        ...
        else
        {
            ...
            double dist = playerEntity.theItemInWorldManager.getBlockReachDistance() + 1;
            dist *= dist;
            if (this.hasMoved && this.playerEntity.getDistanceSq((double)var5 + 0.5D, (double)var6 + 0.5D, (double)var7 + 0.5D) < dist && (var12 > this.mcServer.func_82357_ak() || var9) && (var9 || !dries007.SimpleRegions.regions.VanillaInterface.hasTag(var2, var5, var6, var7, "noplayerblock", getPlayer())))
            {
